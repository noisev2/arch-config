...
sed -i 's/#\(it_IT.UTF-8\)/\1/' /mnt/etc/locale.gen
...
# Set cmdline
zfs set org.zfsbootmenu:commandline="rw quiet nowatchdog rd.vconsole.keymap=it zswap.enabled=0" zroot/ROOT/"$root_dataset"
